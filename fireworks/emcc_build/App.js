...
Module['FS_createPath']("/assets", "shaders", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/shaders/points.frag", "start": 0, "end": 341}, {"filename": "/assets/shaders/points.vert", "start": 341, "end": 626}, {"filename": "/assets/shaders/shader.frag", "start": 626, "end": 1096}, {"filename": "/assets/shaders/shader.vert", "start": 1096, "end": 1569}], "remote_package_size": 1569});

  })();

// end include: /tmp/tmpvgod0iao.js
// include: /tmp/tmpcro0hn73.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpcro0hn73.js
// include: /tmp/tmpquls4e90.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpquls4e90.js
...
// end include: preamble.js
  ...
  function _browser_get_height() {
          return window.innerHeight;
      }

  function _browser_get_width() {
...
var wasmImports = {
  ...
  /** @export */
  browser_get_height: _browser_get_height,
  /** @export */
  browser_get_width: _browser_get_width,
  /** @export */
